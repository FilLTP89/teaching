...
\begin{frame}{Théorème de la divergence [Divergence theorem]}
\txb{120}{0}{11}{
	\centering
...
\begin{frame}{Théorème de la divergence [Divergence theorem]}
	\txb{120}{0}{11}{
		\itmz{
			...
			\itmz{
				\item<3->  $\sum_i\int_{\partial\Omega_i(t) } \At.\nv\pxtp ds = \sum_i\int_{\Omega_i(t)} \divergence \At[i]\pxtp dv $
				...
				\item<5->
				$$\sum_i\int_{\Omega_i(t)} \divergence \At[i] dv =\int_{\Omega} \divergence \At = \int_{\partial\Omega(t) } \At.\nv\pxtp ds -\sum_{K}\int_{\Sigma_K(t)} \disc{\At}.\nv[\Sigma_K] ds$$
			}
		}
